                    ...
                    <div class="linenContactUsFormContainer">
                        <form action="#" method="post" id="contact" >
                            ...
                            <div class="contact_input_container" id="company_msg">
                                <input class="contact_input" id="company" placeholder="COMPANY" size="100" type="text" value="" />
                            </div>
...
<script>
// We pre-filled your app ID in the widget URL: 'https://widget.intercom.io/widget/eozc21ao'
(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',w.intercomSettings);}else{var d=document;var i=function(){i.c(arguments);};i.q=[];i.c=function(args){i.q.push(args);};w.Intercom=i;var l=function(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/eozc21ao';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);};if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();
</script>
	</body>
</html>